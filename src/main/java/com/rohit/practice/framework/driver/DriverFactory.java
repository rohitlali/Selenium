package com.rohit.practice.framework.driver;
...
public enum DriverFactory {
    ...
    public static void main(String[] args) {
        DriverFactory.INSTANCE.initializeWebDriver(DriverFactory.INSTANCE.desiredCapabilities(BROWSER.FIREFOX));
        System.out.printf("test " + DriverFactory.INSTANCE);
    }
}